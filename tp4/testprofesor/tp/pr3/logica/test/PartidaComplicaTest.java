...
public class PartidaComplicaTest {
	...
	private void completaColumna(int c) throws MovimientoInvalido {
		for (int y=1; y<=7; y++) {
			p.ejecutaMovimiento(getMovimiento(c, p.getTurno()));
	...
	public void partidaEnTablas() throws MovimientoInvalido {
		...
		p.ejecutaMovimiento(getMovimiento(3, p.getTurno()));
	...
	public void varios4EnRaya() {
		...
		try {
			...
			fail("Se debería poder poner una ficha en una columna incompleta");
		}
